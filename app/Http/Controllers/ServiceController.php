...
class ServiceController extends Controller
{
    ...
    public function create()
    {
        ...
        // dd($data["price_type_list"]);
        return view('setup.service.create', compact('service', 'data', 'services'));
    }
    ...
    public function store(StoreServicesRequest $request)
    {
        ...
        $request['parent'] = $request->type === "parent" ? 1 : 0;
        ...
        if (is_array($request->sab_categories) && count($request->sab_categories) > 0) {
            $service->subCategories()->attach($request->sab_categories);
        }
    ...
    public function edit(Service $service)
    {
        ...
        $service->sab_categories = $service->subCategories()->pluck('sub_category_id')->toArray();
    ...
    public function update(StoreServicesRequest $request, $id)
    {
        ...
        $service->subCategories()->sync($request->sab_categories);
