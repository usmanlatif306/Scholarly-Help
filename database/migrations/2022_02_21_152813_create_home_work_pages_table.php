...
class CreateHomeWorkPagesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('home_work_pages', function (Blueprint $table) {
            $table->id();
            $table->string('name');
            $table->string('slug');
            ...
            $table->string('subject_area_heading')->nullable();
            $table->text('subject_area_content')->nullable();
            $table->string('subject_area_btn')->nullable();
            $table->string('subject_service_heading')->nullable();
            $table->text('subject_service_content')->nullable();
            $table->string('subject_sample_heading')->nullable();
            $table->text('subject_sample_content')->nullable();
    ...
    {
        Schema::dropIfExists('home_work_pages');
    }
}
