...
Vue.component("Writers", require("./components/writer/Writers.vue").default);
Vue.component("Notify", require("./components/Notifications.vue").default);
Vue.component("Bids", require("./components/Bids.vue").default);
Vue.component("Activity", require("./components/ActivityLog.vue").default);
