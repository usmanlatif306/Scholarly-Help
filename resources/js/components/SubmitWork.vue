                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <VueFileAgent
                            ...
                            :meta="true"
                            :accept="
                                '.zip,.rar,.7zip,.xlsx,.xls, .doc, .docx,.ppt, .pptx,.txt,.pdf, application/msword, application/vnd.ms-excel, application/vnd.ms-powerpoint, text/plain, application/pdf, image/*,jpg'
                            "
                            :maxSize="'10MB'"
                            :maxFiles="1"
                            ...
                            :errorText="{
                                type:
                                    'Invalid file type. Only images, .pdf, .doc Allowed',
