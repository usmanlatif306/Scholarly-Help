                ...
                <div class="mb-4">
                    <p>
                        ...
                        <small class="form-text text-muted"
                            >{{ form.work_level_model.name }} (Work
                            level)</small
                        >

                        <small class="form-text text-muted">
                            {{ form.guarantee_model.name }} (Guarantee)
                        </small>
                    </p>
                    <div>
                        <b>Urgency</b>
                    ...
                    <div
                        v-if="
                            form.service_model.price_type_id ==
                                pricingTypes.fixed
                        "
                    >
                        <div>
                    ...
                    <div
                        v-if="
                            form.service_model.price_type_id ==
                                pricingTypes.perSlide
                        "
                    >
                        <div>
                            <b>Number of slides</b>
                            :
                        ...
                        <tr v-if="form.added_services.length > 0">
                            <td colspan="2">
                                <div>
                                    ...
                                    <div
                                        class="row"
                                        v-for="row in form.added_services"
                                        v-bind:key="row.id"
                                    >
                                        <div class="col-md-6">
