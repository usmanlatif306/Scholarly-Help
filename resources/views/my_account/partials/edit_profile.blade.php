         ...
         <div class="col-lg-12">
            <div class="media align-items-center">
               <a href="#" class="upload_photo">
                  <img class="avatar avatar-lg rounded-circle mr-3 user-avatar" alt="Image placeholder"
                     src="{{ $photo_url }}">
               </a>
               <div>
      ...
      <form autocomplete="off" class="form-horizontal" method="post" action="{{ route('update_my_profile') }}">
         ...
         <div class="form-row">
            ...
            <div class="form-group col-md-12">
               ...
               <input type="text" class="form-control form-control-sm {{ showErrorClass($errors, 'degree') }}"
                  name="degree" value="{{ old('degree', optional($user->meta)->degree) }}">
               <div class="invalid-feedback d-block">
                  {{ showError($errors, 'degree') }}
               </div>
            </div>
            @endif
         </div>
         ...
         <div class="form-group">
            ...
            <textarea class="form-control form-control-sm {{ showErrorClass($errors, 'bio') }}"
               name="bio">{{ old('bio', optional($user->meta)->bio) }}</textarea>
            <div class="invalid-feedback d-block">
         ...
         <div class="form-group">
            ...
            <textarea class="form-control form-control-sm {{ showErrorClass($errors, 'address') }}"
               name="address">{{ old('address', optional($user->meta)->address) }}</textarea>
            <div class="invalid-feedback d-block">
         ...
         <div class="form-group">
            ...
            <input type="text"
               class="form-control form-control-sm {{ showErrorClass($errors, 'preferred_payment_method') }}"
               name="preferred_payment_method"
               value="{{ old('preferred_payment_method', optional($user->meta)->preferred_payment_method ) }}"
         ...
         <div class="form-group">
            ...
            <input type="text"
               class="form-control form-control-sm {{ showErrorClass($errors, 'payment_method_details') }}"
               name="payment_method_details"
               value="{{ old('payment_method_details', optional($user->meta)->payment_method_details ) }}">
            <div class="invalid-feedback d-block">
      ...
      <div class="modal-content">
         ...
         <div class="modal-body">
            <div class="row">
               ...
               <div class="col-md-4">
                  <br />
                  <div class="uploading_spinner text-center form-text text-muted" style="display: none;">Uploading ...
                  </div>
                  <br />
                  <br />
