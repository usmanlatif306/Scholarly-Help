                    ...
                    <div class="btn-group btn-group-nav shadow ml-auto" role="group" aria-label="Basic example">
                        ...
                        <div class="btn-group" role="group">
                            ...
                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow"
                                ...
                                <a class="dropdown-item" href="{{ route('my_account', ['group' => 'wallet']) }}">Wallet
                                    Topup</a>
                        ...
                        <div class="btn-group" role="group">
                            ...
                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow"
                                aria-labelledby="btn-group-settings">
                                <a class="dropdown-item" href="{{ route('my_account') }}?group=edit-profile">Edit
                                    Profile</a>
                                <a class="dropdown-item" href="{{ route('my_account') }}?group=change-password">Change
                                    Password</a>
                            </div>
                        </div>
