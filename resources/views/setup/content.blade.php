...
<form id="contentForm" role="form" class="form-horizontal" enctype="multipart/form-data"
   action="{{ route('settings_update_content', $content->slug) }}" method="post" autocomplete="off">
   {{ csrf_field() }}
   {{ method_field('PATCH') }}
