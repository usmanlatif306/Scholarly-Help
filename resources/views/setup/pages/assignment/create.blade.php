@extends('setup.index')
@section('title', 'Assignment Sub Category Pages')
@section('setting_page')
@include('setup.partials.action_toolbar', [
'title' => (isset($page->id)) ? 'Edit Page' : 'Create new Page',
'hide_save_button' => TRUE,
'back_link' => ['title' => 'back to pages', 'url' => route("assignment.pages.index")],
])
<form role="form" class="form-horizontal"
    action="{{ (isset($page->id)) ? route( 'assignment.pages.update', $page->id) : route('assignment.pages.store') }}"
    method="post" autocomplete="off">
    {{ csrf_field() }}
    @if(isset($page->id))
    {{ method_field('PATCH') }}
    @endif
    @include('setup.partials.action_toolbar', ['title' => 'Assignment Sub Category Pages'])
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item active">Website Frontend</li>
            <li class="breadcrumb-item" aria-current="page">Assignment Sub Category Pages</li>
        </ol>
    </nav>
    <div class="container">
        <div class="row">
...
<script>
    ...
    ClassicEditor
        .create(document.querySelector('#subject_area_content'));
    ClassicEditor
        .create(document.querySelector('#subject_service_content'));
    ClassicEditor
