<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
   ...
   <a class="nav-link" href="{{ route('writer_bid_percentage') }}">Bid Percentage</a>
   <a class="nav-link" href="{{ route('promos.index') }}">Promo Codes</a>
   ...
   <div class="dropdown dropright">
      ...
      <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
         ...
         <a class="dropdown-item" href="{{ route('sub_category_list') }}">Sub Categories</a>
         ...
         <a class="dropdown-item" href="{{ route('guarantee_list') }}">Guarantees
         </a>
   ...
   <div class="dropdown dropright">
      ...
      <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
         ...
         <a class="dropdown-item" href="{{ route('guarantees.index') }}">Guarantees</a>
         <!-- <a class="dropdown-item" href="{{ route('testimonials.index') }}">Testimonials</a> -->
         <!-- <a class="dropdown-item" href="{{ route('tutors.index') }}">Tutors</a> -->
         <a class="dropdown-item" href="{{ route('settings_show_faqs') }}">FAQ</a>

         <a class="dropdown-item" href="{{ route('online_class_settings') }}">Online Class</a>
         <a class="dropdown-item" href="{{ route('online_class.pages.index') }}">Online Class Pages</a>
         <a class="dropdown-item" href="{{ route('online_exam_settings') }}">Online Exam</a>
         <a class="dropdown-item" href="{{ route('online_exam.pages.index') }}">Online Exam Pages</a>
         <a class="dropdown-item" href="{{ route('homework_settings') }}">HomeWork</a>
         <a class="dropdown-item" href="{{ route('homework.pages.index') }}">HomeWork Pages</a>
         <a class="dropdown-item" href="{{ route('assignment_settings') }}">Assignment</a>
         <a class="dropdown-item" href="{{ route('assignment.pages.index') }}">Assignment Pages</a>
         <a class="dropdown-item" href="{{ route('essay_settings') }}">Essay Writing</a>
         <!-- <a class="dropdown-item" href="{{ route('subject_list') }}">Subjects
         </a> -->
         <div class="dropdown-divider"></div>
         <a class="dropdown-item" href="{{ route('about_settings') }}">About Us</a>
         <a class="dropdown-item" href="{{ route('contact_settings') }}">Contact Us</a>
         <a class="dropdown-item" href="{{ route('settings_edit_content', 'money-back-guarantee') }}">Money Back
            Guarantee</a>
         ...
         <a class="dropdown-item" href="{{ route('settings_edit_content', 'terms-and-conditions') }}">Terms &
            Condition</a>
   ...
   <a class="nav-link" href="{{ route('works.index') }}">Past Works</a>
   <a class="nav-link" href="{{ route('tags_list') }}">Subjects</a>
   ...
   <a class="nav-link" href="{{ route('admin_social_urls') }}">Social Urls</a>
