...
<form role="form" class="form-horizontal" enctype="multipart/form-data"
   ...
   <div class="form-group">
      ...
      <select name="type" class="form-control form-control form-control-sm  selectPickerWithoutSearch">
   ...
   <div class="form-group d-none" id="subCategory">
      ...
      <!-- <select name="category" class="form-control">
         ...
         <option value="{{$item->id}}" @if(isset($service->id)) {{ ($service->parent) == $item->id ? 'selected' : ''
            }} @endif>{{$item->name}}</option>
         @endforeach
      </select> -->
      <?php echo form_dropdown("sab_categories[]", $data['sab_categories'], old_set('sab_categories', NULL,$service), "class='form-control form-control-sm  multiSelect' multiple='multiple'") ?>
   </div>
   <div class="form-group"
   ...
   <div class="form-group">
      ...
      <small class="text-muted"><a href="{{ route('additional_services_create') }}">Create Additional
            Service</a></small>
