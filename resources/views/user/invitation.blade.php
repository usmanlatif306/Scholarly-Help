      ...
      <div class="col-md-6">
         <form autocomplete="off" method="POST" action="{{ route('send_invitation') }}">
            ...
            <div class="form-group">
               ...
               <div class="invalid-feedback d-block">@php if($errors->has('email')) { echo $errors->first('email') ; }
                  @endphp</div>
            </div>
            <div class="form-group">
               ...
               <div class="font-14">
                  ...
                  <div class="form-check">
                     <input class="form-check-input" type="radio" name="role_type" id="staff" value="staff" {{
                        ($data['type']=='staff' ) ? 'checked' : '' }}>
                     <label class="form-check-label" for="staff">
                        Staff / Writer
                     </label>
                     <div class="invalid-feedback d-block">@php if($errors->has('role_type')) { echo
                        $errors->first('role_type') ; } @endphp</div>
                  </div>
               </div>
            </div>
