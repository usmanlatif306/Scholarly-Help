...
<section class="slider_area section-bg pb-5">
    ...
    <div class="single_slider">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <h3>{{$page->qualtity_heading_8}}</h3>
                    <p class="section-about">{{$page->qualtity_about_8}}
                    </p>
                </div>
                <div class="col-md-6">
                    <h3>{{$page->qualtity_heading_9}}</h3>
                    <p class="section-about">{{$page->qualtity_about_9}}
                    </p>
                </div>
                <div class="col-md-6">
                    <h3>{{$page->qualtity_heading_10}}</h3>
                    <p class="section-about">{{$page->qualtity_about_10}}
                    </p>
                </div>
            </div>
            <div class="text-center mt-4">
...
@if($page->subject_cover_text)
<!-- subject cover -->
<section id="testimonials" class="testimonials">
    <div class="container" data-aos="fade-up">
        <div class="section-title">
            <h2>{{$page->subject_cover_text}}</h2>
            <p></p>
        </div>
        <div class="col-md-10 offset-md-1">
            {!! $page->subject_cover_content !!}
        </div>
    </div>
</section>
@endif
...
<section id="testimonials" class="testimonials">
    <div class="container" data-aos="fade-up">
        <div class="section-title">
            <h2>{{$page->subject_cover_area_heading}}</h2>
            <p></p>
        </div>
        <div class="col-md-10 offset-md-1">
            {!! $page->subject_cover_area_text !!}
        </div>
    </div>
</section>
<!-- subject cover area end -->
...
<section id="Testimonials" class="testimonials">
    <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
            ...
            <p>{{$page->subject_testimonial_heading}}</p>
        </div>
        <div class="testimonials-slider swiper mt-5" data-aos="fade-up" data-aos-delay="100">
            <div class="swiper-wrapper">
